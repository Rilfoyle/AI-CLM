export default {
  ...
  login: {
    welcome: 'Welcome to TuriX Contract Management',
    message: 'One workspace for drafting, legal collaboration, and approval',
  ...
  sys: {
    api: {
      ...
      errMsg901: 'This write operation is disabled. Contact your administrator.'
    },
    app: {
      logoutTip: 'Reminder',
