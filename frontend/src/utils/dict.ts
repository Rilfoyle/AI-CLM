...
export enum DICT_TYPE {
  ...
  // ========== CLM 模块 ==========
  CLM_APPROVAL_STATUS = 'clm_approval_status', // CLM 合同审批状态：0=未提交 / 1=审批中 / 2=审批通过 / 3=审批驳回 / 4=已取消
  CLM_LIFECYCLE_STATUS = 'clm_lifecycle_status', // CLM 合同生命周期：1=草稿 / 2=已批准 / 3=已生效 / 4=已到期 / 5=已终止 / 6=作废
  CLM_PARTY_TYPE = 'clm_party_type', // CLM 签约方类型：1=企业 / 2=个人
  CLM_CONTRACT_PARTY_ROLE = 'clm_contract_party_role', // CLM 合同签约方角色：OUR_SIDE / COUNTERPARTY / OTHER
  CLM_DOCUMENT_SOURCE_TYPE = 'clm_document_source_type', // CLM 文档版本来源：UPLOAD / ONLINE_EDIT / MANUAL_FINAL
  CLM_TYPE_VERSION_STATUS = 'clm_type_version_status', // CLM 类型版本状态：0=草稿 / 1=已发布
  CLM_WORKFLOW_BINDING_STATUS = 'clm_workflow_binding_status', // CLM 流程绑定状态：0=准备中 / 1=审批中 / 2=通过 / 3=驳回 / 4=取消
  CLM_PARTICIPANT_ROLE = 'clm_participant_role', // CLM 参与人角色：OWNER / COLLABORATOR / VIEWER
  CLM_DOCUMENT_ROLE = 'clm_document_role', // CLM 文档角色：MAIN / ATTACHMENT
  CLM_AUDIT_ACTION = 'clm_audit_action' // CLM 审计动作
}
