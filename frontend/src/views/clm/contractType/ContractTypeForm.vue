...
const formData = ref<ContractTypeApi.ContractTypeVO>({
  id: undefined,
  code: '',
  name: '',
  description: '',
...
const open = async (type: string, id?: number) => {
  ...
  if (id) {
    ...
    try {
      formData.value = await ContractTypeApi.getContractType(id)
    } finally {
...
const submitForm = async () => {
  ...
  formLoading.value = true
  try {
    const data = formData.value as ContractTypeApi.ContractTypeVO
    if (formType.value === 'create') {
      await ContractTypeApi.createContractType(data)
      message.success(t('common.createSuccess'))
    } else {
      await ContractTypeApi.updateContractType(data)
